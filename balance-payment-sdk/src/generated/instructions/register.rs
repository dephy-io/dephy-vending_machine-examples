...
impl Register {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&RegisterInstructionData::new()).unwrap();
...
impl Default for RegisterInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `Register`.
///
/// ### Accounts:
///
...
/// `register` CPI accounts.
pub struct RegisterCpiAccounts<'a, 'b> {
...
/// `register` CPI instruction.
pub struct RegisterCpi<'a, 'b> {
...
impl<'a, 'b> RegisterCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RegisterCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Register` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` user_account
...
///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct RegisterCpiBuilder<'a, 'b> {
    instruction: Box<RegisterCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RegisterCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RegisterCpiBuilderInstruction {
            __program: program,
            user_account: None,
            user: None,
            vault: None,
...
#[derive(Clone, Debug)]
struct RegisterCpiBuilderInstruction<'a, 'b> {
