...
impl Pay {
  pub fn instruction(&self, args: PayInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: PayInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&PayInstructionData::new()).unwrap();
...
impl Default for PayInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
    ...
    let accounts = Pay {
          ...
          let args = PayInstructionArgs {
                                                              namespace_id: self.namespace_id.clone().expect("namespace_id is not set"),
                                                                  ...
                                                                  amount_to_transfer: self.amount_to_transfer.clone().expect("amount_to_transfer is not set"),
                                    };
...
pub struct PayCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: PayInstructionArgs,
  }

impl<'a, 'b> PayCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: PayCpiAccounts<'a, 'b>,
...
/// Instruction builder for `Pay` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` namespace_account
          ...
          ///   7. `[]` system_program
#[derive(Clone, Debug)]
pub struct PayCpiBuilder<'a, 'b> {
  instruction: Box<PayCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PayCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(PayCpiBuilderInstruction {
      __program: program,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = PayInstructionArgs {
                                                              namespace_id: self.instruction.namespace_id.clone().expect("namespace_id is not set"),
                                                                  ...
                                                                  amount_to_transfer: self.instruction.amount_to_transfer.clone().expect("amount_to_transfer is not set"),
                                    };
        let instruction = PayCpi {
...
#[derive(Clone, Debug)]
struct PayCpiBuilderInstruction<'a, 'b> {
